...
import com.thinkport.streams.topology.StatelessTopoplogy;
...
public class TopologyTestDriverTests {
  ...
  void adminUser() throws Exception {
    ...
    clickJsonTopic.pipeInput("9000", cj);
    assertEquals("9000", shopClicksErroneous.readValue().getUserId());
  }
}
